...
namespace UserModule_PYTHONEXAMPLE
{
    public class UserModuleClass_PYTHONEXAMPLE : SplusObject
    {
...
public UserModuleClass_PYTHONEXAMPLE ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
